...
$test_stripe = array(
  "secret_key"      => "sk_test_mxjmToQ6VbCGBu89fj4GVFvs",
  "publishable_key" => "pk_test_iIeycUJttWAHKFJVe0fJuJWX"
);

$prod_stripe = array(
  "secret_key"      => "pk_live_f26pizyAdldjeE08uALZ3Gpk",
  "publishable_key" => "sk_live_7TU5M8ECf5mf9ShkjvvkXT3w"
);
    ...
    <div class="main-container donation-form" xmlns="http://www.w3.org/1999/html">
        <div class="row">
            ...
            var handler = StripeCheckout.configure({
                              key: 'pk_live_f26pizyAdldjeE08uALZ3Gpk',
