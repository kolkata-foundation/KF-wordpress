...
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-center ngo-title">
                <ul class="social">
                    ...
                    if(!$result[0]->ngo_twitter_url == ""){
                        echo '<li class="tweet"><a href="'.$result[0]->ngo_twitter_url.'" target="_blank"><i class="fa fa-twitter"></i></a></li>'; }
    ...
    <div class="main-container ngo-page-content">
        <div class="row">
            <?php $goal = $result[0]->current_fundraising_goal;
            //if(!empty($goal)){
           /* if(!ctype_space($goal) && !empty($goal)){
            echo '<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 tabbed">';
            }
            else{
            echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tabbed">';
            }*/
            ?>
<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 tabbed">
           <!-- <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 tabbed"> -->
                ...
                <iframe width="480" height="420" src="https://www.youtube.com/embed/<?php echo $result[0]->ngo_video_id; ?>" frameborder="0" allowfullscreen></iframe>
                <?php } ?>
                <?php if(!$result[0]->ngo_impact_title_one == "" || !$result[0]->ngo_impact_title_two == "" || !$result[0]->ngo_impact_title_three == "" || !$result[0]->ngo_impact_title_four == ""){ ?>
